...
const projects = [
  {
    ...
    type: "Brand Identity",
    desc: "精品咖啡品牌视觉系统",
    image: "/img/Visual Notes/6.jpg",
  },
  {
    name: "AURORA",
    type: "Visual Identity",
    desc: "美妆品牌视觉系统",
    image: "/img/Visual Notes/3.jpg",
  },
];
      ...
      <section id="works" className="py-32 px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {projects.map((project, i) => (
            ...
            >
              <div 
                className="aspect-[4/5] overflow-hidden bg-surface mb-8"
                onClick={() => openLightbox(project.image, project.name)}
              >
                <img 
                  src={project.image} 
                  alt={project.name} 
